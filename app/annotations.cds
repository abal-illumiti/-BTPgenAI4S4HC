using { abal_01_d04Srv } from '../srv/service.cds';

annotate abal_01_d04Srv.CustomerMessages with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate abal_01_d04Srv.CustomerMessages with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate abal_01_d04Srv.CustomerMessages with @UI.Identification: [{ Value: customerMessageID }];
annotate abal_01_d04Srv.CustomerMessages with @UI.DataPoint #titleEnglish: {
  Value: titleEnglish,
  Title: 'Title in English',
};
annotate abal_01_d04Srv.CustomerMessages with @UI.DataPoint #customerName: {
  Value: customerName,
  Title: 'Customer Name',
};
annotate abal_01_d04Srv.CustomerMessages with @UI.DataPoint #productName: {
  Value: productName,
  Title: 'Product Name',
};
annotate abal_01_d04Srv.CustomerMessages with {
...
annotate abal_01_d04Srv.CustomerMessages with @UI.LineItem: [
...
annotate abal_01_d04Srv.CustomerMessages with @UI.FieldGroup #Main: {
...
annotate abal_01_d04Srv.CustomerMessages with @UI.HeaderFacets: [
...
annotate abal_01_d04Srv.CustomerMessages with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate abal_01_d04Srv.CustomerMessages with @UI.SelectionFields: [
  customerMessageID
];
