...
const { preprocessCustomerMassage } = require('./orchestration');

/**
 * Message categorization, urgency classification, service categorization and summarization and translation
 * @Before(event = { "READ" }, entity = "abal_01_d04Srv.CustomerMessages")
...
module.exports = async function(request) {
	...
	try {
		...
		const customerMessages = await SELECT.from('abal_01_d04.CustomerMessages').forUpdate();
